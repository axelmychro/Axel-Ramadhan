...
var section = {
	...
	about: {
		...
		philosophy: {
			...
			description: "Warna kontras, font gampang dibaca, elemen secukupnya supaya kamu bisa fokus ke layar. Corner dikasih rounded-full? Gak dulu deh, makasih. Tajam, jelas, dan fitur yang jelas pasti menang. Filosofi ini sangat pas dengan model komponen di Vue.",
