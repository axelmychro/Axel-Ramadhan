...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "73f549d6-5fce-4213-84e9-218f3f09be24",
  ...
  en: [
    {
      ...
      load: () => import('./en.mjs' /* webpackChunkName: "locale_en_46json_65d8289e" */),
      cache: true
    }
  ],
  id: [
    {
      ...
      load: () => import('./id.mjs' /* webpackChunkName: "locale_id_46json_df36fd1d" */),
      cache: true
    }
  ]
};
...
const _Jb1YSM1fa7OyvgX2ytbrq_XLxptmNmilhobPgsx474M = defineNitroPlugin(async (nitro) => {
  ...
  nitro.hooks.hook("render:before", async ({ event }) => {
    ...
    if (!url.pathname.includes("/_i18n/6mVo0nMo") && !isExistingNuxtRoute(path)) {
      return;
    }
...
const _pj8sanKovZuHPzZz7VLZpmRBeaA4n1erasK8voLcPTU = (function(nitro) {
...
const _1tzEoc = lazyEventHandler(() => {
...
export { $fetch$1 as $, sanitizeStatusCode as A, getContext as B, baseURL as C, createHooks as D, isEqual$1 as E, executeAsync as F, stringifyParsedURL as G, stringifyQuery as H, parseQuery as I, toRouteMatcher as J, createRouter$1 as K, defu as L, getRequestURL as M, getCookie as N, getRequestHeader as O, klona as P, createDefu as Q, withLeadingSlash as R, parseURL as S, parse as T, isEqual as U, withoutTrailingSlash as V, parsePath as W, setCookie as X, deleteCookie as Y, encodeParam as Z, encodePath as _, appRootTag as a, withTrailingSlash as a0, buildAssetsURL as b, appRootAttrs as c, appSpaLoaderTag as d, appSpaLoaderAttrs as e, useRuntimeConfig as f, getRouteRulesForPath as g, getResponseStatusText as h, getResponseStatus as i, joinHeaders as j, appId as k, defineRenderHandler as l, appTeleportTag as m, normalizeCookieHeader as n, appTeleportAttrs as o, publicAssetsURL as p, getQuery as q, createError$1 as r, appHead as s, destr as t, useNitroApp as u, getRouteRules as v, hasProtocol as w, isScriptProtocol as x, joinURL as y, withQuery as z };
