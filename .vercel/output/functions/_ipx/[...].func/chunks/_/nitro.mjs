...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "77ad6e3d-d2d3-4e3f-b6c8-ed7f5bb9b1ee",
...
const _ujYZv1nrhFd9GI0hlmwpJ39qEC6ufeqNRSz4MjIcVj8 = defineNitroPlugin(async (nitro) => {
  ...
  nitro.hooks.hook("render:before", async ({ event }) => {
    ...
    if (!url.pathname.includes("/_i18n/M81MJ6ck") && !isExistingNuxtRoute(path)) {
      return;
    }
...
export { $fetch$1 as $, getContext as A, baseURL as B, createHooks as C, isEqual$1 as D, executeAsync as E, stringifyParsedURL as F, stringifyQuery as G, toRouteMatcher as H, createRouter$1 as I, defu as J, getRequestURL as K, getCookie as L, getRequestHeader as M, klona as N, createDefu as O, withLeadingSlash as P, parseURL as Q, isEqual as R, withoutTrailingSlash as S, parsePath as T, setCookie as U, deleteCookie as V, encodeParam as W, encodePath as X, withTrailingSlash as Y, appRootTag as a, buildAssetsURL as b, appRootAttrs as c, appSpaLoaderTag as d, appSpaLoaderAttrs as e, useRuntimeConfig as f, getResponseStatusText as g, getResponseStatus as h, appId as i, defineRenderHandler as j, publicAssetsURL as k, appTeleportTag as l, appTeleportAttrs as m, getQuery as n, createError$1 as o, parseQuery as p, appHead as q, destr as r, getRouteRules as s, toNodeListener as t, useNitroApp as u, hasProtocol as v, isScriptProtocol as w, joinURL as x, withQuery as y, sanitizeStatusCode as z };
